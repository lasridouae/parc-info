...
LOCK TABLES `pcseuls` WRITE;
/*!40000 ALTER TABLE `pcseuls` DISABLE KEYS */;
INSERT INTO `pcseuls` VALUES ('p4','Poste 4','130.120.80','04','PCWS','s02'),('p5','Poste 5','130.120.80','05','PCWS','s02'),('p11','Poste 11','130.120.82','01','PCNT','s21'),('p12','Poste 12','130.120.82','02','PCWS','s21');
/*!40000 ALTER TABLE `pcseuls` ENABLE KEYS */;
UNLOCK TABLES;
